...
<html>
    ...
    <body>
        ...
        ";
        // line 13
        $this->loadTemplate("header.html", "article/index.html.twig", 13)->display($context);
        // line 14
        echo "
        ...
        <div class=\"container\">
            ...
            Cliquez sur un article pour le consulter              
...
";
    ...
    {
        return array (  131 => 6,  113 => 5,  89 => 34,  76 => 32,  72 => 31,  53 => 14,  51 => 13,  43 => 7,  41 => 6,  37 => 5,  31 => 1,);
    }
            ...
            <div class=\"center-text\">
                <div class=\"list-group\">
                    {% for article in articles %}
                        <a href=\"/article/{{ article.id}}\" class=\"list-group-item\">{{ article.title }}<br/>   <span class=\"subtitle\">{{ article.subtitle }}</span>  </a>
                    {% endfor %}
                </div>
            </div>
        </div>
