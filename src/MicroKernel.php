...
final class MicroKernel
{
    ...
    {
        //$this->routes->add('route_name', new Route('/', ['_controller' => 'App\Controller\ProductController']));
        $this->routes->add('route_name', new Route('/', ['_controller' => 'App\Controller\CommandeController']));
